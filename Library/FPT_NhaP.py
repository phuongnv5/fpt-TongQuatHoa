...
class FPT_NhaP:
    ...
    def Dich_Nha(self):
        try:
            ...
            #arcpy.CopyFeatures_management("C:/Generalize_25_50/50K_Goc.gdb/DanCuCoSoHaTang/NhaP", "C:/Generalize_25_50/50K_Process.gdb/DanCuCoSoHaTang/NhaP")
            arcpy.AddMessage("\n# Bat dau dich NhaP")
            _path_Layer_NhaP = "C:/Generalize_25_50/50K_Process.gdb/DanCuCoSoHaTang/NhaP"
            _path_Layer_NhaP_In = "C:/Generalize_25_50/50K_Process.gdb/DanCuCoSoHaTang/NhaP_In"
            _path_Layer_NhaP_Out = "C:/Generalize_25_50/50K_Process.gdb/DanCuCoSoHaTang/NhaP_Out"
            ...
            arcpy.CalculateField_management(_path_Layer_NhaP, "NHAP_REP1_ID", "1", "PYTHON_9.3")
            ...
            arcpy.CopyFeatures_management(_path_Layer_NhaP, _path_Layer_NhaP_Out)
            arcpy.MakeFeatureLayer_management(_path_Layer_NhaP_Out, "NhaP_lyr")
            ...
            arcpy.CopyFeatures_management("NhaP_lyr", _path_Layer_NhaP_In)
            #arcpy.SelectLayerByLocation_management (in_layer = "NhaP_lyr", overlap_type = "WITHIN", select_features = _path_Layer_DoanTimDuongBo_Buffer_2)
            arcpy.DeleteFeatures_management("NhaP_lyr")
            
            arcpy.Buffer_analysis(_path_Layer_NhaP_Out, _path_Layer_NhaP_Out + "_Buffer", "60 Meters")
            arcpy.AddMessage("\n# Hoan thanh!!!")
